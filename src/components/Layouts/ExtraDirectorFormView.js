...
class DirectorFormView extends Component {
    ...
    handleSubmit = async data => {
        const { navigation, save, companyRegData, updateDirectors, index } = this.props;
        const {
            sex,
            documentType,
            dob,
    ...
    render() {
        ...
        return (
            <View>
                ...
                <Text style={[Custom.mv20, Typography.FONT_BOLD]}>Second Director</Text>
                <Formik
                    initialValues={{
                        surname: '',
                        firstName: '',
