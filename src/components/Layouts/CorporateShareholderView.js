...
class CorporateShareholderView extends Component {
    ...
    handleSubmit = async data => {
        const { index, updateCorporates, updatePSCs } = this.props;
        const {
            sex,
            dob,
            nationality,
        ...
        if (country === 'Nigeria') regData['companyAddress']['lga'] = lga;
                    ...
                    {({
                        ...
                        handleBlur
                            ...
                            <View>
                                ...
                                <Text style={[styles.boldText, Custom.mv10]}>Company Address</Text>
...

                                {
                                    country === 'Nigeria' ?
                                        ...
                                        <View>
                                            <CustomInput
                                                name='companyAddress.lga'
                                                value={values.companyAddress.lga}
                                                placeholder='LGA'
                                                // customStyle={[Custom.mt20]}
                                                iconName='asterisk'
                                                iconColor={Colors.DANGER}
                                                onChangeText={handleChange('companyAddress.lga')}
                                                onBlur={handleBlur('companyAddress.lga')}
                                            />
                                            <ErrorMessage errorValue={getIn(touched, 'companyAddress.lga') && getIn(errors, 'companyAddress.lga')} />
                                        </View>
                                }
                                ...
                                <CustomInput
                                    ...
                                    iconName='asterisk'
                                    iconColor={Colors.DANGER}
                                    onChangeText={handleChange('companyAddress.city')}
                                    onBlur={handleBlur('companyAddress.city')}
                                />
                                <ErrorMessage errorValue={getIn(touched, 'companyAddress.city') && getIn(errors, 'companyAddress.city')} />
                                ...
                                <CustomInput
                                    ...
                                    // iconName='asterisk'
                                    iconColor={Colors.DANGER}
                                    onChangeText={handleChange('companyAddress.postalCode')}
                                    onBlur={handleBlur('companyAddress.postalCode')}
                                />
                                <ErrorMessage errorValue={getIn(touched, 'companyAddress.postalCode') && getIn(errors, 'companyAddress.postalCode')} />

                                <CustomInput
                                    name='companyAddress.houseNumber'
                                    value={values.companyAddress.houseNumber}
                                    placeholder='House Number/Building Name'
                                    // customStyle={[Custom.mt20]}
                                    iconName='asterisk'
                                    iconColor={Colors.DANGER}
                                    onChangeText={handleChange('companyAddress.houseNumber')}
                                    onBlur={handleBlur('companyAddress.houseNumber')}
                                />
                                <ErrorMessage errorValue={getIn(touched, 'companyAddress.houseNumber') && getIn(errors, 'companyAddress.houseNumber')} />

                                <CustomInput
                                    name='companyAddress.streetName'
                                    value={values.companyAddress.streetName}
                                    placeholder='Street Name'
                                    // customStyle={[Custom.mt20]}
                                    iconName='asterisk'
                                    iconColor={Colors.DANGER}
                                    onChangeText={handleChange('companyAddress.streetName')}
                                    onBlur={handleBlur('companyAddress.streetName')}
                                />
                                <ErrorMessage errorValue={getIn(touched, 'companyAddress.streetName') && getIn(errors, 'companyAddress.streetName')} />
